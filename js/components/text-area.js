		...
		return (
			<form className="textArea" onSubmit={this.handleSubmitEvent}>
				<div className="form-group">
					...
					<input type="text" id="titleInput" onChange={this.handleTitleChange} className="form-control" placeholder={this.props.userTitle} />
				</div>
				<div className="form-group">
					<label htmlFor="story-area">Write story below:</label>
					<textarea id="storyInput" className="form-control" rows="3" onChange={this.handleStoryChange} placeholder={this.props.userStory}></textarea>
				</div>
				<div className="form-group">
					<label htmlFor="author-input">By:</label>
					<input type="text" id="authorInput" onChange={this.handleAuthorChange} className="form-control" placeholder={this.props.newAuthor} />
				</div>
